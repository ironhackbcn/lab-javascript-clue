...
function pickMistery() {
  // here I delete "var" before misteryEnvelope to make it global for further purpose. althoug I think there is better/cleaner way
  misteryEnvelope = [];
...
function revealMistery(misteryEnvelope) {
  ...
  console.log(
    `${firstName} ${lastName} killed Mr.Boddy using the ${weapon}  in the ${place} !!!!`
  );
}
